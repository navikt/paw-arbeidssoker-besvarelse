...
data class Config(
    val database: DatabaseConfig = DatabaseConfig(
        dotenv["NAIS_DATABASE_PAW_ARBEIDSSOKER_BESVARELSE_ARBEIDSSOKER-REGISTRERT_HOST"],
        dotenv["NAIS_DATABASE_PAW_ARBEIDSSOKER_BESVARELSE_ARBEIDSSOKER-REGISTRERT_PORT"],
        dotenv["NAIS_DATABASE_PAW_ARBEIDSSOKER_BESVARELSE_ARBEIDSSOKER-REGISTRERT_DATABASE"],
        dotenv["NAIS_DATABASE_PAW_ARBEIDSSOKER_BESVARELSE_ARBEIDSSOKER-REGISTRERT_USERNAME"],
        dotenv["NAIS_DATABASE_PAW_ARBEIDSSOKER_BESVARELSE_ARBEIDSSOKER-REGISTRERT_PASSWORD"]
    ),
