...
data class Config(
    val database: DatabaseConfig = DatabaseConfig(
        dotenv["NAIS_DATABASE_PAW_ARBEIDSSOKER_BESVARELSE_BESVARELSE_HOST"],
        dotenv["NAIS_DATABASE_PAW_ARBEIDSSOKER_BESVARELSE_BESVARELSE_PORT"],
        dotenv["NAIS_DATABASE_PAW_ARBEIDSSOKER_BESVARELSE_BESVARELSE_DATABASE"],
        dotenv["NAIS_DATABASE_PAW_ARBEIDSSOKER_BESVARELSE_BESVARELSE_USERNAME"],
        dotenv["NAIS_DATABASE_PAW_ARBEIDSSOKER_BESVARELSE_BESVARELSE_PASSWORD"]
    ),
